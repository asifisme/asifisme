...
export default function Home() {
    ...
    const experiences: ExperienceItemData[] = [
        {
            ...
            description:
                "Led full-stack development on scalable, high-impact projects using Django, Next.js, and microservices architecture.",
            achievements: [
        ...
        },
        {
            ...
            description:
                "Drove backend innovation for financial platform, focusing on secure APIs, cloud infrastructure, and team collaboration.",
            achievements: [
        ...
        },
        {
            ...
            description:
                "Contributed to full-stack HR solutions, specializing in Django-based accounting and financial modules.",
            achievements: [
    ...
    const certifications = [
        {
            ...
            docs_link:
                "https://training.edge.gov.bd/certificate-validation?certificate_no=EDGE-DSTS-115-6709-00009",
            description:
    ...
    return (
        <main className="min-h-screen bg-[#0f172a] py-2 sm:py-4 md:py-6 lg:py-10">
            ...
            <div className="mx-auto mb-4 w-full px-3 sm:px-4 md:w-[210mm] md:px-4">
            ...
            {/* Resume Container */}
            <div className="mx-auto min-h-[297mm] w-full px-3 sm:px-4 md:w-[210mm] md:px-4">
                <div
                    id="resume-container"
                    className="rounded-lg bg-white p-3 shadow-lg sm:p-4 md:p-4"
                >
                    <Header {...headerData} />
                    <div className="mt-3 grid grid-cols-1 gap-4 sm:mt-2 sm:gap-3 md:mt-2 md:grid-cols-3 md:gap-4">
                        {/* Left column */}
                        <section className="space-y-4 md:col-span-2 md:space-y-3">
                        ...
                        <aside className="space-y-4 md:col-span-1 md:space-y-3">
